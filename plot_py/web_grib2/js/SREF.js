...
function load_image(frm){
  ...
  for(k=begin; k<37; k++){
    ...
    filename="../../"+frm.dy.options[frm.dy.selectedIndex].value+"/"+frm.cyc.options[frm.cyc.selectedIndex].value+"/"+ frm.reg.options[frm.reg.selectedIndex].value+"/"+ frm.sub.options[frm.sub.selectedIndex].value+"/"+frm.prod.options[frm.prod.selectedIndex].value+".t"+frm.cyc.options[frm.cyc.selectedIndex].value+"z."+data+".png";
    preload(filename);
  }
  show(0);
}
